          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4 justify-center mb-8">
                <a href="./docs/public/docs/Caio_Querino_Curriculo_MPRJ.pdf" className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-to-br from-[#00d4ff] to-[#0099cc] text-white font-semibold hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(0,212,255,0.2)] transition-all duration-300" download>
